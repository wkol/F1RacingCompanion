...
class LiveTimingUtilsTest {
    ...
    fun createWebSocketUrl() {
        ...
        assertEquals("wss://livetiming.formula1.com/signalr/connect?transport=webSockets&connectionToken=testToken&connectionData=%5B%7B%22name%22%3A%20%22Streaming%22%7D%5D&clientProtocol=1.5", webSocketPath)
    }
    ...
    fun createWebSocketUrl_encodeToken() {
        ...
        assertEquals("wss://livetiming.formula1.com/signalr/connect?transport=webSockets&connectionToken=test%20Token&connectionData=%5B%7B%22name%22%3A%20%22Streaming%22%7D%5D&clientProtocol=1.5", webSocketPath)
    }
}
