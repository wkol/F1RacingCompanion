...
class LiveTimingDataParserTest {
    ...
    fun jsonToLiveTimingStats() {
        ...
        val jsonStr = "{'H':'Streaming','M':'feed', 'A':['TimingStats', {'Lines': {'7': {'BestSpeeds': {'I1': {'Position': 2}}}, '14': {'BestSpeeds': {'I1': {'Position': 3}}}}}, '2021-10-08T08:30:51.596Z']}"
    ...
    fun jsonToLiveTimingData() {
        ...
        Assert.assertEquals(liveTimingData.data!!.lines[4]!!.timeDiffFastest, "+5.804")
    }
}
